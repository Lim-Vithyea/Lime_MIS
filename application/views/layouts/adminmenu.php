...
<nav class="navbar navbar-expand-md" style="background-color: blue;">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="<?php echo $this->createUrl("/admin/"); ?>">
            <img src="<?= Yii::app()->baseUrl ?>/assets/images/PED.png" height="34" class="d-inline-block align-bottom" alt="">
            <?= $sitename ?>
        </a>
        <!-- Only on xs screens -->
            ...
            <ul class="nav navbar-nav">
                ...
                <?php if (Permission::model()->hasGlobalPermission('superadmin', 'read')): ?>
                    <li class="nav-item d-flex">
                        <a href="<?php echo $this->createUrl("surveyAdministration/Chart"); ?>" class="nav-link ps-0">
                            <span><?php eT("View Chart") ?></span>
                        </a>
                    </li>
                <?php endif; ?> 
                <!-- dashboard -->
                ...
                <?php if (Permission::model()->hasGlobalPermission('superadmin', 'read')): ?>
                    <li class="nav-item d-flex">
                        <a href="<?php echo $this->createUrl("userManagement/index"); ?>" class="nav-link ps-0">
                            <span><?php eT("User Management") ?></span>
                        </a>
                    </li>
                <?php endif; ?> 
